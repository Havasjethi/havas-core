...
export abstract class BaseCoreRouter<Endpoint extends {methodName: string},
  MiddleWare,
  ErrorHandler,
  ...
  public endpoints: {[name: string| number | symbol]: Endpoint} = {};
  ...
  public setParent (parent: AnyRouter): this {
    this.parent = parent;
